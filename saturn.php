        ...
        <div id="main">
            <div class='row intro'>
                <div class="col-sm-6 col-xs-12">
                    <br>
                    <div class='desc'>
                        <h4 class="headers">Take a Stroll Through the Solar System</h4>
                        <div class='block'>
                ...
                <div class="col-sm-6 col-xs-12 paddingTop">
                    ...
                    <br>
                    <div class='desc'>
                        <h4 class="headers">Planetary Passport</h4>
                        <div class='block'>
                    ...
                    <br>
                    <div class='desc'>
                        <h4 class="headers">Free Passport</h4>
                        <div class='block'>
            ...
            <div class='row intro'>
                <div class="col-sm-12">
                    <br>
                    <div class='desc'>
                        <h4 class="headers">Carl Sagan</h4>
